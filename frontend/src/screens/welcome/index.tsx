...
export default function Welcome() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900">
      ...
      <section className="relative px-4 py-12 sm:py-16 lg:py-24">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 sm:w-96 sm:h-96 bg-blue-500/10 rounded-full blur-3xl"></div>
            <div className="absolute top-1/3 left-1/3 w-48 h-48 sm:w-64 sm:h-64 bg-purple-500/10 rounded-full blur-3xl"></div>
            <div className="absolute bottom-1/3 right-1/3 w-56 h-56 sm:w-80 sm:h-80 bg-emerald-500/10 rounded-full blur-3xl"></div>
          </div>

          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 px-3 py-1 sm:px-4 sm:py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 mb-6 sm:mb-8">
              <span className="w-2 h-2 bg-emerald-400 rounded-full animate-pulse"></span>
              <span className="text-emerald-300 text-xs sm:text-sm font-medium">AI-Powered Mathematical Assistant</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-8 sm:mb-12 px-4">
              <Button 
                onClick={() => navigate('/calculate')}
                size="lg"
                className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-base sm:text-lg px-6 py-3 sm:px-8 sm:py-4 h-auto w-full sm:w-auto"
              >
              ...
              <Button 
                ...
                variant="outline"
                size="lg"
                className="border-white/20 text-white hover:bg-white/10 text-base sm:text-lg px-6 py-3 sm:px-8 sm:py-4 h-auto w-full sm:w-auto"
              >
                Learn More
              </Button>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 max-w-4xl mx-auto px-4">
              ...
              <div className="text-center">
                ...
                <div className="text-gray-400 text-xs sm:text-sm">Math Subjects</div>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-bold text-white mb-1 sm:mb-2">AI</div>
                <div className="text-gray-400 text-xs sm:text-sm">Powered Engine</div>
              </div>
              <div className="text-center">
      ...
      {/* Problem Types */}
      <section className="px-4 py-12 sm:py-16 bg-white/5 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {problemTypes.map((type, index) => (
              <div key={index} className="bg-black/30 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-white/10 hover:border-white/20 transition-all duration-300 hover:scale-105">
                <div className={`w-10 h-10 sm:w-12 sm:h-12 bg-${type.color}-500/20 rounded-xl flex items-center justify-center mb-3 sm:mb-4`}>
                  <span className={`text-xl sm:text-2xl text-${type.color}-400`}>{type.icon}</span>
                </div>
                <h3 className="text-lg sm:text-xl font-semibold text-white mb-2 sm:mb-3">{type.name}</h3>
                <div className="space-y-1">
                  {type.examples.map((example, i) => (
                    <div key={i} className="text-gray-400 text-xs sm:text-sm">• {example}</div>
                  ))}
                </div>
              </div>
            ))}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {features.map((feature, index) => (
              <div key={index} className="group relative bg-black/20 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-white/10 hover:border-white/20 transition-all duration-300 hover:scale-105">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-white mb-2 sm:mb-3">1. Draw</h3>
              <p className="text-gray-400 text-sm sm:text-base px-2">Write your mathematical expression naturally on our digital canvas using mouse or touch</p>
            </div>

            <div className="text-center">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6">
                <svg className="w-6 h-6 sm:w-8 sm:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                </svg>
              </div>
              <h3 className="text-lg sm:text-xl font-semibold text-white mb-2 sm:mb-3">2. Analyze</h3>
              <p className="text-gray-400 text-sm sm:text-base px-2">Our AI recognizes your handwriting and understands the mathematical context instantly</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-white mb-2 sm:mb-3">3. Solve</h3>
              <p className="text-gray-400 text-sm sm:text-base px-2">Get instant solutions with optional step-by-step explanations for deeper understanding</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 py-12 sm:py-16">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 backdrop-blur-sm rounded-3xl p-8 sm:p-12 border border-white/10">
            ...
            <Button 
              onClick={() => navigate('/calculate')}
              size="lg"
              className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-base sm:text-lg px-8 py-3 sm:px-12 sm:py-4 h-auto w-full sm:w-auto"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* Footer */}
      <footer className="px-4 py-6 sm:py-8 border-t border-white/10">
        <div className="max-w-7xl mx-auto text-center">
          <div className="flex items-center justify-center gap-3 mb-3 sm:mb-4">
            <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center">
              <span className="text-white text-xs sm:text-sm font-bold">N</span>
            </div>
            <span className="text-white font-semibold text-sm sm:text-base">NeuroMath</span>
          </div>
